...
module.exports = class User {
  ...
  static async insert({ email, passwordHash, first_name, last_name, city, state, marital_status }) {
    const { rows } = await pool.query(
      `
          ...
          RETURNING 
            *
          `, 
      [email, passwordHash, first_name, last_name, city, state, marital_status]
    );
