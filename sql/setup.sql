...
CREATE TABLE profiles (
  profiles_id BIGINT ALWAYS GENERATED AS IDENTITY PRIMARY KEY,
  email TEXT NOT NULL,
...
CREATE TABLE goals (
  goal_id BIGINT ALWAYS GENERATED AS IDENTITY PRIMARY KEY,
...
CREATE TABLE gigs (
  gig_id BIGINT ALWAYS GENERATED AS IDENTITY PRIMARY KEY,
  gig_name NOT NULL,
...
CREATE TABLE favorites (
  favorite_id BIGINT ALWAYS GENERATED AS IDENTITY PRIMARY KEY,
  profiles_id INT NOT NULL REFERENCES profiles(profiles_id),
